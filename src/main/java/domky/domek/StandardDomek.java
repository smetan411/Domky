...
public class StandardDomek extends PlayerCommandExecutor {

    @Override
    public boolean onCommandPlayer(Player player, World world, Location playerLocation, String[] args) {
        StandardDomek mujDomek = new StandardDomek(svet, pocatekDomu);
        mujDomek.postavStandardDomek();
        return true;
    }

    private final World svet;
    private final AbsLocation pocatekDomu;
    private final int sirkaDomu = 10;
    private final int delkaDomu = 10;
    private final int vyskaSten = 6;

    public StandardDomek(World svet, AbsLocation pocatekDomu) {
        this.svet = svet;
        this.pocatekDomu = pocatekDomu;
    }

    public void postavStandardDomek() {
        postavZakladDesku();
        postavStenuSJ(0);
